...
def test_users(test_client):
    ...
    # Test get user list
    test_result = [{'firstname': 'Pasha', 'id': 1, 'age': 40, 'lastname': 'Technique', 'username': 'user1', 'slug': 'user1'}, {'firstname': 'Bear', 'id': 3, 'age': 50, 'lastname': 'Grylls', 'username': 'user3', 'slug': 'user3'}]
